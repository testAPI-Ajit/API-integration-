...
//                System.out.print("No data   ------------>"+jsonInputString);
            ...
            if(response.getYV_TPT_CFACONT() != null){
            ...
            if(response.getYV_TPT_CFARATES() != null){
...
//                System.out.print("No data   ------------>"+jsonInputString);
            ...
            if(response.getET_EXCH_RATE() != null) {
